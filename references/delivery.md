...
> **Out of Scope**: Creative strategies (refer to [treatment.md](treatment.md)), prompt engineering (refer to [shot-language.md](shot-language.md)), storyboards & videos (refer to [storyboard.md](storyboard.md)).
