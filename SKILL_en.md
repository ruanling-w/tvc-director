...
- 8 specialized TVC narrative models (refer to [references/treatment_en.md](references/treatment_en.md) Part 1)
...
- Camera choreography and lighting design for Cinematic Product Breakdown (refer to [references/storyboard_en.md](references/storyboard_en.md) Part 3)
- Visual language design for brand world scenes
- Visual metaphors, color arcs, and brand color integration (refer to [references/treatment_en.md](references/treatment_en.md) Part 2)

**Prompt Engineering Layer** — Nano Banana Pro + Seedance Specialization
- Structured Chinese prompt generation (6-layer structure, refer to [references/shot-language_en.md](references/shot-language_en.md) Part 1)
- TVC scene type adaptation (refer to [references/shot-language_en.md](references/shot-language_en.md) Part 3)
- Style anchor vocabulary A-E (refer to [references/shot-language_en.md](references/shot-language_en.md) Part 2)
...
- **Brand World Thinking**: The product exists within a brand world—the vehicle of the brand world varies by product category (see details in [references/treatment_en.md](references/treatment_en.md))
...
**Product Placement Strategy**: (How does the product appear?—Cinematic Product Breakdown / Brand World Crosscut / Lifestyle Film. For selection criteria, see `references/treatment_en.md`)
**On-Camera Strategy**: (Who is on camera? How are they shown?)
  ...
  (For the decision framework and default strategies per category of the on-camera strategy, see `references/treatment_en.md`)
...
For the complete TVC Creative Pitch Document format, narrative models, and visual aesthetics design principles, see [references/treatment_en.md](references/treatment_en.md).
...
For the detailed anchor vocabulary, combination examples, and C/D comparisons of each art style direction, see [references/shot-language_en.md](references/shot-language_en.md) Part 2.
...
1. Output prompts for each asset image in sequence (format is detailed in [references/delivery_en.md](references/delivery_en.md) Part 1).
...
For asset planning framework and generation standards, see [references/pre-production_en.md](references/pre-production_en.md).
For prompting methods and scene type templates, see [references/shot-language_en.md](references/shot-language_en.md).
For the Cinematic Product Breakdown system, see [references/storyboard_en.md](references/storyboard_en.md) Part 3.
...
**60s TVC**: Refer to the 60s adaptation schemes of various models in [references/treatment_en.md](references/treatment_en.md) Part 1.
...
- **Without Asset Images** → Reused in text form via "standard description anchors" in the global style layer (see [references/pre-production_en.md](references/pre-production_en.md) Part 3)
...
For product placement strategy selection criteria, see [references/treatment_en.md](references/treatment_en.md). For complete video prompt examples, see [references/storyboard_en.md](references/storyboard_en.md) Part 3 Section 6.

For video prompt writing specifications and the product cinematic system, see [references/storyboard_en.md](references/storyboard_en.md).
...
- **Incorrect product materials** → Adjust material description words (refer to [references/storyboard_en.md](references/storyboard_en.md) Part 3).
...
For the complete iteration strategy and common failure modes, see [references/delivery_en.md](references/delivery_en.md) Part 2.
...
├── storyboard_en.md                   # Storyboard script (if any)
│
...
The knowledge base of this skill is organized as reference files by responsibility, loaded as needed. It has been marked in the body of SKILL_en.md when to read which Part of which file.

| Role | File | Mission | Stage of Use |
|------|------|------|---------|
| Creative Director | `references/treatment_en.md` | TVC director's thinking framework, on-camera strategy, category adaptation | Creative Pitch |
| Pre-production | `references/pre-production_en.md` | Asset planning, generation sequence, various asset standards, consistency maintenance | Pre-production |
| Camera Language | `references/shot-language_en.md` | Prompt syntax, art style anchor vocabulary, scene type templates, composition paradigms | Visual Keynoting / Pre-production / Storyboarding & Filming |
| Storyboard & Video | `references/storyboard_en.md` | Multi-grid storyboards, video prompts, product breakdown, brand world | Storyboarding & Filming |
| Delivery & Iteration | `references/delivery_en.md` | Output format templates, iterative debugging | Pre-production / Storyboarding & Filming / Review / Delivery |
